...
**Expected:** `https://sourcevia-app.preview.emergentagent.com`
...
2. Go to: https://sourcevia-app.preview.emergentagent.com/login
...
```javascript
fetch('https://sourcevia-app.preview.emergentagent.com/api/auth/login', {
  method: 'POST',
...
**URL:** https://sourcevia-app.preview.emergentagent.com (not http://)
...
✅ API responds correctly: https://sourcevia-app.preview.emergentagent.com/api
