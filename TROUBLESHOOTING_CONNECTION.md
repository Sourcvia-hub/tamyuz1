...
**Expected:** `https://procure-hub-14.preview.emergentagent.com`
...
2. Go to: https://procure-hub-14.preview.emergentagent.com/login
...
```javascript
fetch('https://procure-hub-14.preview.emergentagent.com/api/auth/login', {
  method: 'POST',
...
**URL:** https://procure-hub-14.preview.emergentagent.com (not http://)
...
✅ API responds correctly: https://procure-hub-14.preview.emergentagent.com/api
